...
def load_records():
    ...
    return pd.DataFrame(columns=[
        "日付", "race_id", "jyo", "race",
        "honmei", "honmei_umaban", "honmei_win_p",
        "taiko", "taiko_umaban", "taiko_win_p",
        "ana", "ana_umaban", "ana_win_p",
...
def record_from_prediction(race_id, pdf):
    ...
    record = {
        ...
        "ana_umaban":    top3h.get("馬番", np.nan) if top3h is not None else None,
