...
# 2026-08-29 更新。**買い方は一切変えていない。**
#   検証データ(resid_kinds_pred.csv)を現行の特徴量で作り直したため、
#   同じ買い方でも点数と的中がわずかに動いた。
#     旧 10,349点 / 的中1178 / 120.6%（8/17の特徴量）
#     新 10,388点 / 的中1161 / 119.2%（8/25の特徴量）
#   差は1.4pt。10,349点での95%区間が[104%, 140%]なので、区別できる差ではない。
#   **8日ぶんの学習差は買い目にほとんど影響していなかった**ということ。
EXPECT = {"買い方": "軸gap>=1.5 単勝 ＋ ダートならワイド(相手gap>=1.3・最大3頭)",
          "点数": 10388, "的中": 1161, "ROI": 119.2}
