...
# 2026-09-03 更新。**買い方は一切変えていない。**
#   壊れていた元データ（クラス・回り・賞金）を直し、特徴量・モデル・検証データを
#   作り直した結果、数字が下がった。
#     旧 10,388点 / 的中1161 / 119.2%（クラスが7月以降100%欠損の状態）
#     新 10,374点 / 的中1128 / 107.6%（クラス0%欠損）
#   券種別 単勝 118.4%→114.9% / ワイド 121.0%→91.7%
#
#   ⚠ 95%区間が100%を含むようになった。
#     全体 [94%, 123%] / 単勝 [98%, 136%] / ワイド [69%, 117%]
#     **この買い方が黒字だとは、もう言えない。**
EXPECT = {"買い方": "軸gap>=1.5 単勝 ＋ ダートならワイド(相手gap>=1.3・最大3頭)",
          "点数": 10374, "的中": 1128, "ROI": 107.6}
