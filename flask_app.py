...
# ── 評価グレードのしきい値（2026-08-16・5段階に再設計）──────────────
#   2026-08-15版は「馬券内率70/50/30%」でしきい値を引いたが、B評価が全体の
#   45.8%を占めて粗すぎた（1レースに6.35頭がB）。しかもCが作れなかった
#   （Bの馬券内率21.1%とCの目標15%が近すぎて分離できない）。
#
#   そこで「1レースに何頭出すか」で切り直した。こちらの方が画面が読みやすい。
#     S:0.5頭 / A:+1.5頭 / B:+2.0頭 / C:+2.0頭 / D:残り
#
#   クリーンデータ5年OOS 207,518頭・14,972レースでの実績。
#
#     評価  しきい値   馬券内率  勝率   1R当り  出現するレース  複勝ROI
#     S     ≥1.349     70.2%  35.9%   0.50頭      41.8%   88.6%
#     A     ≥0.885     49.4%  19.5%   1.50頭      82.2%   81.3%
#     B     ≥0.598     34.6%  11.4%   2.00頭      89.0%   79.2%
#     C     ≥0.420     24.1%   6.6%   2.00頭      86.9%   78.7%
#     D     それ未満     9.4%   2.2%   7.86頭      99.9%   66.9%
#
#   Sは1番人気(64.7%)を上回り、6割のレースでは出ない。出たときに意味を持つ。
#   Dは馬券内率9.4%・複勝ROI66.9%で、明確に「買わない」と言える水準。
#   ⚠ しきい値を変えたら、この表も実測で更新すること。
GRADE_TH = [("S", 1.349), ("A", 0.885), ("B", 0.598), ("C", 0.420)]
