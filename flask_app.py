...
#   Dの馬券内率が6.7%までしか下がらなかった。Cを無くしてBを広く取ると
#   Dが5.3%まで下がり、「来ない馬」として明確になる。
#
#     評価  しきい値   馬券内率  勝率    1R当り  複勝ROI
#     S     ≥1.555     75.8%  42.0%   0.23頭   90.5%
#     A     ≥0.907     52.4%  21.6%   1.66頭   82.2%
#     B     ≥0.223     23.4%   6.8%   7.30頭   78.4%
#     D     それ未満     5.3%   1.0%   4.67頭   59.6%
#
#   Sは馬券内率75.8%で1番人気(64.7%)を大きく上回る。1レースに0.23頭しか出ない。
#   Dは5.3%＝19回に1回しか来ない。明確に「来ない馬」として買わない判定に使う。
#   ⚠ しきい値を変えたら、この表も実測で更新すること。
GRADE_TH = [("S", 1.555), ("A", 0.907), ("B", 0.223)]
